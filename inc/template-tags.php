...
?>
	class="
		...
		<?php if ( get_theme_mod( 'progression_studios_nav_cat_count') == 'off') : ?> progression-studios-nav-count-cat-off<?php endif; ?>	
...
?>
	...
	<div class="width-container-pro optional-centered-area-on-mobile">
		...
		<div class="mobile-menu-icon-pro noselect"><i class="fa fa-bars"></i><?php if (get_theme_mod( 'progression_studios_mobile_menu_text', 'on') == 'on' ) : ?><span class="progression-mobile-menu-text"><?php echo esc_html__( 'Menu', 'ratency-progression' )?></span><?php endif; ?></div>
...
function progression_studios_infinite_content_nav_pro( $html_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<div id="infinite-nav-pro-default" class="infinite-nav-pro">
			<div class="nav-previous"><?php next_posts_link( wp_kses( __('Load More <span><i class="fa fa-arrow-circle-down"></i></span>', 'ratency-progression' ) , TRUE) ); ?></div>
		</div>
	<?php endif;
}
endif;
