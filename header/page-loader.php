	...
	<div id="page-loader-pro" class="finished-loading u-fixed">
	  <div id="center-loader">
	    ...
	    <?php if (get_theme_mod( 'progression_studios_loading_text_new')) : ?><div id="loading-pro">
	      <?php echo esc_attr(get_theme_mod('progression_studios_loading_text_new')); ?><span>.</span><span>.</span><span>.</span>
	    </div><?php endif; ?>
