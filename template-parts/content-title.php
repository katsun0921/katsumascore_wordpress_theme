...
<div id="page-title-pro"
  style="<?php if (has_post_thumbnail()): ?>background-image:url('<?php echo esc_attr($image); ?>')" <?php endif; ?>
  class="u-mb-50px l-title">
  <div id="progression-studios-page-title-container" class="l-container">
    <?php if ($is_post) : ?>
