...
<li class="<?php echo esc_attr($settings['progression_elements_slider_css3_animation']); ?>">
	...
	<div class="progression-elements-slider-background" <?php if (has_post_thumbnail() || get_post_meta($post->ID, 'progression_studios_gallery-image-url', true)) : ?> <?php
							...
							<div class="progression-ratency-slider-content-margins">
								...
								<div class="progression-ratency-slider-content-alignment">
									<div class="progression-ratency-slider-progression-crowd-index-content">
										...
										<?php if ($settings['progression_elements_post_category'] == 'yes') : ?><div class="progression-ratency-slider-categories"><?php the_category(' '); ?></div><?php endif; ?>
										...
										<?php if ($settings['progression_elements_post_author'] == 'yes' || $settings['progression_elements_post_date'] == 'yes' || $settings['progression_elements_post_comments'] == 'yes') : ?>
											<ul class="progression-ratency-slider-meta">
												<?php if ($settings['progression_elements_post_author'] == 'yes') : ?><li class="blog-meta-author-display"><?php esc_html_e('By', 'ratency-progression'); ?> <?php the_author(); ?></li><?php endif; ?>
												...
												<?php if ($settings['progression_elements_post_comments'] == 'yes') : ?><li class="blog-meta-comments">
