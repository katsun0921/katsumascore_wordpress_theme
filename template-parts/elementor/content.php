        ...
        <div class="progression-studios-float-blog-content-padding">
          ...
          <?php if ('post' == get_post_type()) : ?>
            <ul class="progression-post-meta">
              ...
              <?php if ($settings['progression_elements_post_display_author'] == 'yes') : ?><li class="blog-meta-author-display"><?php esc_html_e('By', 'ratency-progression'); ?> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename')); ?>"><?php the_author(); ?></a>
                </li><?php endif; ?>
