...
<div <?php post_class(); ?>>
	<div class="progression-studios-default-blog-index progression-studios-default-blog-left <?php echo esc_attr(get_theme_mod('progression_studios_blog_transition')); ?>">
				...
				<div class="progression-studios-float-blog-content-padding">
					...
					<?php if ('post' == get_post_type()) : ?>
						<ul class="progression-post-meta">
							...
							<?php if ($settings['progression_elements_post_display_author'] == 'yes') : ?><li class="blog-meta-author-display"><?php esc_html_e('By', 'ratency-progression'); ?> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename')); ?>"><?php the_author(); ?></a></li><?php endif; ?>
							...
							<?php if ($settings['progression_elements_post_display_comments'] == 'yes') : ?><li class="blog-meta-comments"><?php comments_popup_link(esc_html__('0 comments', 'ratency-progression'), '1 ' . esc_html__('comment', 'ratency-progression'),   '% ' . esc_html__('comments', 'ratency-progression')); ?></li><?php endif; ?>
						</ul>
