...
?>
  <section>
    ...
    <?php if ($is_cinema_showing) : ?>
      ...
      <a href="<?php echo esc_url($cinema_list_filed); ?>" target="_blank" rel="noopener"><?php echo $title_jp . 'の劇場情報'; ?></a>
    <?php else : ?>
...
?>
  <section>
    ...
    <?php else : ?>
      <a href="<?php echo esc_url($vod_service_url); ?>" target="_blank" rel="noopener"><?php echo $vod_service_name . ' ' . $title_jp; ?></a>
    <?php endif; ?>
    <div class="u-my-6">
