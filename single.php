...
<?php while (have_posts()) : the_post(); ?>
  ...
  <div id="progression-studios-post-page-title">
    ...
    <?php if ('post' == get_post_type()) : ?><?php if (get_theme_mod('progression_studios_blog_post_index_meta_category_display', 'true') == 'true') : ?><div id="progression-studios-post-category"><?php the_category(' '); ?></div><?php endif; ?><?php endif; ?>
    <h1 class="progression-post-single-title"><?php echo get_post_meta($post->ID, 'title_jp', true); ?>の<br>あらすじ、感想、評価まとめ</h1>

    <?php if ('post' == get_post_type()) : ?>
      <ul class="progression-studios-single-post-meta">
        <?php if (get_theme_mod('progression_studios_blog_post_meta_author_display', 'true') == 'true') : ?><li class="blog-meta-author-display"><?php esc_html_e('By', 'ratency-progression'); ?> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename')); ?>"><?php the_author(); ?></a></li><?php endif; ?>
        <?php if (get_theme_mod('progression_studios_blog_post_meta_date_display', 'true') == 'true') : ?>
          ...
          <?php endif; ?>
        <?php endif; ?>
        <?php if (get_theme_mod('progression_studios_blog_post_meta_comment_display', 'true') == 'true') : ?><li class="blog-meta-comments"><?php comments_popup_link(esc_html__('0 comments', 'ratency-progression'), '1 ' . esc_html__('comment', 'ratency-progression'),   '% ' . esc_html__('comments', 'ratency-progression')); ?></li><?php endif; ?>
      </ul>
    <?php endif; ?>
